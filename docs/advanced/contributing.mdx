...
| `packages/react-three-jolt/src/addons` | `@react-three/jolt/addons` — [input commands](/api/addons), helper components |
| `packages/react-three-jolt/src/controllers` | `@react-three/jolt/controllers` — [character, camera rig, vehicles](/api/controllers) |
