...
| package | range | why |
| --- | --- | --- |
| `react`, `react-dom` | `>=19.0 <19.3` | the range `@react-three/fiber` 10 accepts. `react@19.3` is **outside** it; use `19.2.x`. |
| `@react-three/fiber` | `>=10.0.0-0` | currently `10.0.0-alpha.5` |
| `@react-three/drei` | `>=11.0.0-0` | currently `11.0.0-alpha.7`; used by [`<Heightfield>`](/api/shapes#heightfields) |
| `three` | `>=0.185` | |
