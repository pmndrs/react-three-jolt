...
const Changer: React.FC<ChangerProps> = memo((props) => {
  ...
  const geometries = useMemo(() => {
    ...
    const sphereShape = getShapeSettingsFromGeometry(sphereGeo)!
    ...
    const boxShape = getShapeSettingsFromGeometry(boxGeo)!
      .shapeSettings!.Create()
      .Get();
    ...
    const torusShape = getShapeSettingsFromGeometry(torusGeo)!
      .shapeSettings!.Create()
      .Get();
