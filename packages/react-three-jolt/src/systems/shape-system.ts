...
export const getShapeSettingsFromObject = (
    ...
    console.log('Generating compound shape for:', shapes);
    const compoundShapeSettings = new Raw.module.StaticCompoundShapeSettings();

    for (const { shapeSettings, offset, position, quaternion } of shapes) {
...
export const getShapeSettingsFromGeometry = (
    ...
    switch (shapeType) {
        ...
        case 'capsule': {
            ...
            const { radius, length: height } = (geometry as CapsuleGeometry)
                .parameters;
        ...
        case 'cylinder': {
            ...
            const { radiusTop, height } = (geometry as CylinderGeometry)
                .parameters;
        ...
        case 'convex': {
            ...
            // merge points
            const mergedPoints =
                BufferGeometryUtils.mergeVertices(simplifiedGeo);
