...
export class VehicleSystem {
    ...
    createVehicleSettings(settings) {
    ...
    addVehicle(name, settings?) {
        settings = this.createVehicleSettings(settings);
        let vehicle;
        console.log('adding vehicle', name, settings.type);
        switch (settings.type) {
            case 'twoWheel':
                vehicle = new VehicleManagerTwoWheels(
                    this.physicsSystem,
                    settings
                );
                break;
            default:
                vehicle = new VehicleFourWheelManager(
                    this.physicsSystem,
                    settings
                );
                break;
    ...
    private attachToLoop() {
        ...
        this.physicsSystem.addPostStepListener((deltaTime) =>
